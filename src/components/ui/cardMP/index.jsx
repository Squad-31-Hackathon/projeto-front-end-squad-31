        ...
        >
          <form className={styles.divE} onSubmit={handleSubmit}>
            ...
            <div className={styles.midleE}>
              <label
                className={`${styles.textImgE} ${
                  imageSrc && styles.whiteBackground
                }`}
                tabIndex="0"
              >
                <input
                ...
                <div id="imgText">
                  {imageSrc ? (
                    <img
                      src={imageSrc}
                      alt="Selected"
                      className={styles.selectedImageE}
                    />
                  ) : (
              ...
              <div className={styles.formE}>
                <InputNormal
                  ...
                  funcButton={(e) => handleChange(e, "title")}
                />
                <InputNormal
                  name="tags"
                  children={"Tags"}
                  value={formData.tags}
                  funcButton={(e) => handleChange(e, "tags")}
                />
                <InputNormal
                  children={"Link"}
                  name="link"
                ...
                <TextInput
                  ...
                  funcButton={(e) => handleChange(e, "description")}
                />
              </div>
            </div>
        ...
        >
          <div className={styles.divEx}>
            ...
            <div className={styles.finalEx}>
              <AddButton onClick={handleDelete} type="submit" children={"EXCLUIR"} />
