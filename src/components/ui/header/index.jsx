    ...
    <header className={styles.header}>
        ...
        <Container maxWidth="xl">
          <Toolbar disableGutters>
              ...
              >
                ...
                {pages.map((page) => (
                  <MenuItem key={page} onClick={handleCloseNavMenu}>
                    <Typography className={styles.texto} textAlign="center">{page}</Typography>
                  </MenuItem>
                ))}
                </div>
            ...
            <img className={styles.img} src="../../../../public/LOGO-ORANGEPORTFOLIO.png"/>
            <Typography
              variant="h5"
              noWrap
              component="a"
            ...
            <Box className={styles.font} sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
              {pages.map((page) => (
                <Button
